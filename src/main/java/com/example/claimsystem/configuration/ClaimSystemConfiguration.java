package com.example.claimsystem.configuration;
...
@Configuration
public class ClaimSystemConfiguration {
    @Bean
    public WebServiceTemplate webServiceTemplate(SaajSoapMessageFactory messageFactory,
        ...
        webServiceTemplate.setDefaultUri("http://localhost:8080/ws"); // SOAP service endpoint URL
